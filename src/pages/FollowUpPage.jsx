        ...
        <div style={{
          ...
          {saved ? (
            <div style={{
              ...
              padding: '12px', borderRadius: '10px', background: '#DCFCE7', color: '#16A34A',
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <div style={{ textAlign: 'right' }}>
                        ...
                        <p style={{ fontSize: '11px', marginTop: '2px', color: f.urgency === 'urgent' ? '#DC2626' : '#D97706', fontWeight: 600 }}>
                          {f.absenceDuration}
                        </p>
                      </div>
                      <div style={{
