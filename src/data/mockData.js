...
export const students = [
  {
    ...
    followUpHistory: [
      { date: '14 مارس 2026', type: 'مكالمة', notes: 'تواصلنا مع الأهل، المخدوم كان مريضاً', status: 'تم التواصل', servant: 'أ. مينا كمال' },
    ],
    notes: 'مخدوم متميز ومواظب. يشارك في أنشطة الكورال.',
  },
  {
    id: 2,
    name: 'كيرلس مرقس',
  ...
  },
  {
    ...
    followUpHistory: [],
    notes: 'مخدوم جديد. بدأ الحضور منذ شهر.',
  },
  {
    id: 5,
...
export const followUpLogs = [
  {
    ...
    time: 'منذ ساعتين',
    type: 'زيارة',
    notes: 'زيارة منزلية: الأسرة ترحب بالخادم. المخدوم سيعود للحضور القادم.',
  },
  {
    id: 2,
    ...
    time: 'أمس 4:30 م',
    type: 'مكالمة',
    notes: 'مكالمة هاتفية: المخدوم مريض قليلاً. تم الصلاة معه هاتفياً.',
  },
  {
    id: 3,
